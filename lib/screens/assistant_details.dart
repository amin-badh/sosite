                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  "\$${NumberFormat("#,##0.00", "en_US").format(_getTip())} + \$2/h",
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: _valid
                                  ? () {
                                      FirebaseFirestore.instance
                                          ...
                                          .where('state', whereIn: ["active", "waiting"])
                                          .get()
                                          .then((query) {
                                            if (query.docs.isNotEmpty) {
                                              Constants.showSnackBar(
                                                  context, "Sorry, they already got a request, try later.");
                                            } else {
                                              FirebaseFirestore.instance
                                                  .collection('users')
                                                ...
                                                try {
                                                  ...
                                                  try {
                                                    String b = value.get('balance').toString();
                                                  ...
                                                  if (balance > double.parse(_tipController.text)) {
                                                    ...
                                                    Constants.showSnackBar(context, "Insufficient Balance!");
                                                  }
                                                } catch (e) {
                                                  if (kDebugMode) {
                                                    print(e.toString());
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    "Hire ${widget.assistantDoc.get('firstName')} ${widget.assistantDoc.get("lastName")}",
