...
import 'package:sosite/screens/assistant_details.dart';
...
class _AssistantsScreenState extends State<AssistantsScreen> {
  ...
  Future<List<Map<String, DocumentSnapshot<Object?>>>> _getAssistants() async {
    ...
    List<DocumentSnapshot> locations = await geo
        ...
        .within(center: center, radius: 2, field: 'location', strictMode: true)
        .firstWhere((element) => true);

    if (locations.isEmpty) {
      throw Exception("No Assistants in your location.");
    }
